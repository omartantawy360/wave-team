...
const tech = [
  {
    name: "HTML5",
    icon: `<svg class="w-8 h-8" viewBox="0 0 512 512"><path d="M108.4 0h23v22.8h21.2V0h23v69h-23V46h-21v23h-23.2M206 23.1h-20.3V0h63.7v23.1H229V69h-23M259.5 0h24.1l14.8 24.3L313.2 0h24.1v69h-23V34.8l-16.1 24.8l-16.1-24.8v34.2h-22.6M348.7 0h23v46.2h32.6V69h-55.6" fill="#FFFFFF"/><path d="M107.6 471l-33-370.4h362.8l-33 370.2L255.7 512" fill="#E44D26"/><path d="M256 480.5V131H404.3L376 447" fill="#F16529"/><path d="M142 176.3h114v45.4h-64.2l4.2 46.5h60v45.3H154.4M156.4 336.3H202l3.2 36.3 50.8 13.6v47.4l-93.2-26" fill="#EBEBEB"/><path d="M369.6 176.3H255.8v45.4h109.6M361.3 268.2H255.8v45.4h56l-5.3 58.8-50.7 13.6v47.2l93-25.8" fill="#FFFFFF"/></svg>`,
    color: "#E34F26",
  },
  {
    name: "CSS3",
  ...
  {
    name: "JavaScript",
    icon: `<svg class="w-8 h-8" viewBox="0 0 24 24"><rect width="24" height="24" rx="3.6" fill="#F7DF1E"/><path d="M22.034 18.268c0 1.419-.81 2.526-2.355 3.216-1.05.474-1.665.738-1.665 1.282 0 .441.3.743.91.743.6 0 .979-.299 1.233-.848h2.228c-.361 1.826-1.564 3.097-3.385 3.097-2.257 0-3.702-1.385-3.702-3.298 0-1.926 1.144-2.88 2.822-3.555 1.114-.44 1.776-.798 1.776-1.385 0-.52-.391-.84-.96-.84-.87 0-1.411.51-1.712 1.3H12.28c.285-1.957 1.681-3.237 3.83-3.237 2.455 0 4.004 1.258 4.004 3.355l1.92.368zm-8.919-3.238H10v5.304c0 .8-.4 1.2-1.11 1.2-.6 0-.9-.3-.9-1.1v-5.404H5.404v5.503c0 2.2 1.2 3.3 3.3 3.3 2.01 0 3.3-1.1 3.3-3.3v-5.803h.111z" fill="#000000"/></svg>`,
    color: "#F7DF1E",
  },
  {
    name: "React",
  ...
  {
    name: "Bootstrap",
    icon: `<svg class="w-8 h-8" viewBox="0 0 24 24"><rect width="24" height="24" rx="4" fill="#7952B3"/><path d="M14 17.5H6.5v-11H14c1.66 0 3 1.34 3 3 0 1.13-.63 2.11-1.56 2.62.93.51 1.56 1.49 1.56 2.62 0 1.66-1.34 3-3 3zm-4.5-8.5H12c.55 0 1-.45 1-1s-.45-1-1-1H9.5v2zm0 5.5H12c.55 0 1-.45 1-1s-.45-1-1-1H9.5v2z" fill="#FFFFFF" fill-rule="evenodd"/></svg>`,
    color: "#7952B3",
  },
  {
    name: "Node.js",
