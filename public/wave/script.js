...
const projects = [
  ...
  },
  {
    ...
    title: "Travel Agency",
    desc: "A beautiful travel agency website highlighting exotic destinations and custom tour packages.",
    tech: ["HTML", "CSS", "JavaScript"],
...
const translations = {
  ...
  ar: {
    ...
    "project-1-title": "Tech Store",
    "project-1-desc": "متجر لبيع المنتجات التقنية بتصميم عصري وأنيق وميزات تفاعلية.",
    "project-2-title": "Malaz Caffe",
    "project-2-desc": "موقع ويب لمقهى عصري بتصميم أنيق وتجربة مستخدم سلسة.",
    "project-3-title": "Academic Enterprise",
    "project-3-desc": "منصة للمؤسسات الأكاديمية لعرض برامجها وأبحاثها.",
    "project-4-title": "Travel Agency",
    "project-4-desc": "موقع ويب جذاب لوكالة سفر يستعرض وجهات سياحية مميزة وباقات رحلات مخصصة.",
