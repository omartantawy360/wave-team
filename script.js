...
const tech = [
  ...
  {
    name: "CSS3",
    icon: `<svg class="w-8 h-8" viewBox="0 0 512 512"><path d="M71.357 460.819L30.272 0h451.456l-41.129 460.746L255.724 512z" fill="#264DE4"/><path d="M256 480.523V27.742h155.088L375.717 447.3z" fill="#2965F1"/><path d="M114.18 168.29h141.82v47.03H152.37l3.12 48.03h100.51v47.21l-89.09 24.87-89.09-24.87-6.08-68.07h47.18l3.09 34.56 44.91 12.09 44.91-12.09 4.69-52.65h-152.56l-6.08-56.03z" fill="#EBEBEB"/><path d="M256 168.29v47.03h109.18l-3.12 48.03H256v47.21l89.09 24.87 6.08-68.07-6.08 68.07-89.09 24.87v48.06l93.27-25.81L420.38 168.29z" fill="#FFF"/></svg>`,
    color: "#1572B6",
  },
  {
    name: "JavaScript",
    icon: `<svg class="w-8 h-8" viewBox="0 0 24 24"><rect width="24" height="24" fill="#F7DF1E"/><path d="M0 0h24v24H0V0zm22.034 18.276c-.175-1.095-.888-2.015-3.003-2.873-.736-.345-1.554-.585-1.797-1.14-.091-.33-.105-.51-.046-.705.15-.646.915-.84 1.515-.66.39.12.75.42.976.9 1.034-.676 1.034-.676 1.755-1.125-.27-.42-.404-.601-.586-.78-.63-.705-1.469-1.065-2.834-1.034l-.705.089c-.676.165-1.32.525-1.71 1.005-1.14 1.291-.811 3.541.569 4.471 1.365 1.02 3.361 1.244 3.616 2.205.24 1.17-.87 1.545-1.966 1.41-.811-.18-1.26-.586-1.755-1.336l-1.83 1.051c.21.48.45.689.81 1.109 1.74 1.756 6.09 1.666 6.871-1.004.029-.09.24-.705.074-1.65l.046.067zm-8.983-7.245h-2.248c0 1.938-.009 3.864-.009 5.805 0 1.232.063 2.363-.138 2.711-.33.689-1.18.601-1.566.48-.396-.196-.597-.466-.83-.855-.063-.105-.11-.196-.127-.196l-1.825 1.125c.305.63.75 1.172 1.324 1.517.855.51 2.004.675 3.207.405.783-.226 1.458-.691 1.811-1.411.51-.93.402-2.07.397-3.346.012-2.054 0-4.109 0-6.179l.004-.056z" fill="#000"/></svg>`,
    color: "#F7DF1E",
  },
  {
    name: "React",
